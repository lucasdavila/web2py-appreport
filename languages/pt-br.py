...
'Appreport is an implementation of module "appscaffold" in web2py framework, so that the user can enter data through a GUI, appscaffold works as a factory for applications based on MVC pattern.': 'Appreport is an implementation of module "appscaffold" in web2py framework, so that the user can enter data through a GUI, appscaffold works as a factory for applications based on MVC pattern.',
...
'Getyouapp is an implementation of module "appscaffold" in web2py framework, so that the user can enter data through a GUI, appscaffold works as a factory for applications based on MVC pattern.': 'Getyouapp is an implementation of module "appscaffold" in web2py framework, so that the user can enter data through a GUI, appscaffold works as a factory for applications based on MVC pattern.',
'Group ID': 'Group ID',
'Groups': 'Groups',
